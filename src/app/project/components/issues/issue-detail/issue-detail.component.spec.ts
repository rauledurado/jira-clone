import {IssueDetailComponent} from '@raulsanz/project/components/issues/issue-detail/issue-detail.component';
import {IssuePriority, IssueStatus, IssueType} from '@raulsanz/interface/issue';
